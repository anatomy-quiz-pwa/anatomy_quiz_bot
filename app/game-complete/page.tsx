...
export default function GameCompletePage() {
  ...
  const leaderboardData = [
    ...
    { rank: 3, name: "陳醫師 (你)", score: totalScore, avatar: "/api/placeholder/40/40", isCurrentUser: true }
  ];
  ...
  if (!gameStarted) {
    return (
      <div className="min-h-screen bg-[#F4E8D8] p-5 flex items-center justify-center">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-[#fffaf5] border-2 border-[#1C1C1C] rounded-lg p-8 shadow-[8px_8px_0_#1C1C1C]">
            <div className="mb-6">
              <div className="w-20 h-20 bg-[#C57B57] rounded-full mx-auto mb-4 flex items-center justify-center">
                <span className="text-3xl">🦷</span>
              </div>
              <h1 className="text-3xl font-bold mb-2">解剖咬一口</h1>
              <p className="text-gray-600">每天學一點解剖、咬一口文獻！</p>
            </div>
            
            <div className="mb-8">
              <h2 className="text-xl font-bold mb-4">遊戲規則</h2>
              <ul className="text-left space-y-2 text-gray-700">
                <li>• 每題限時 5 分鐘</li>
                <li>• 答對一題獲得 10 分</li>
                <li>• 共有 {questions.length} 道題目</li>
                <li>• 答題後可查看詳細解釋</li>
              </ul>
            </div>
