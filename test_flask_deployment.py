...
def test_flask_deployment():
    ...
    try:
        ...
        if response.status_code == 200:
            print("🎉 Flask 版本部署成功！webhook 正常運作")
            return True
...
def wait_for_deployment():
    """等待部署完成"""
    print("⏳ 等待部署完成...")
    print("💡 請確保您已經將 Flask 版本上傳到 Render 並重新部署")
...
def main():
    ...
    # 測試 webhook
    webhook_ok = test_flask_deployment()
