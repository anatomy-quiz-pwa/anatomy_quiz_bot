...
def test_ultra_simple_webhook():
    """測試超簡單版本的 webhook"""
    print("🔍 測試超簡單版本的 webhook...")
    ...
    try:
        ...
        if response.status_code == 200:
            print("✅ 超簡單版本 webhook 正常運作")
            return True
        else:
            print(f"❌ 超簡單版本 webhook 返回狀態碼: {response.status_code}")
            return False
...
def main():
    ...
    # 測試完整的 webhook
    webhook_ok = test_ultra_simple_webhook()
