...
def test_deployment_after_minimal_fix():
    """測試最簡單修復後的部署"""
    print("🔍 測試最簡單修復後的部署...")
...
def wait_for_deployment():
    """等待部署完成"""
    print("⏳ 等待部署完成...")
    print("💡 請確保您已經將最簡單版本上傳到 Render 並重新部署")
...
def main():
    ...
    # 測試 webhook
    webhook_ok = test_deployment_after_minimal_fix()
    ...
    if webhook_ok:
        ...
        print("📱 收到的 Flex Message 會顯示「排行榜功能正在測試中...」")
    else:
        print("\n" + "=" * 60)
        print("❌ 最簡單修復失敗")
