...
def test_extreme_simple_deployment():
    """測試極簡版本部署"""
    print("🔍 測試極簡版本部署...")
...
def main():
    ...
    # 測試 webhook
    webhook_ok = test_extreme_simple_deployment()
    ...
    if webhook_ok:
        ...
        print("💡 用戶輸入「排行榜」、「leaderboard」、「排名」或「排行」都會收到 JSON 響應")
        print("📱 收到的響應會顯示「排行榜請求已收到」")
